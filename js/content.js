...
const varios = {
    ...
    'content':Array(
        ...
        'table':[
            ...
            {'option':'Chamoyada (sin alcohol)',                                    'price_chica':45, 'price_chica_top':70},
        ]},
    ),
};
const aguachiles = {
...
const kids = {
    ...
    'content':Array(
        ...
        'flavors':['Palito de chocolate', 'Bocadin', 'Moneda de chocolate', 'Malvavisco cubierto', 'Huesitos de chocolate', 'Chocoretas', 'Mini lunetas', 'Huevitos', 'Chocofresky\'s', 'Galleta waffle', 'Mini bubulubu', 'Piña en almíbar'],
        'table':[
            {},
        ]},
        {'subtitle':'',
        ...
        'table':[
            ...
            {'option':' ', 'price_grande':110,  'price_grande_top':150},
        ]},
